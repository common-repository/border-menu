...
if ( count( $result ) > 0 ) {
  foreach ( $result as $key => $val ) {
    ...
    if ( $user == true && $lang == true ) {
      ...
      wp_enqueue_script( $this->plugin_slug . '-classie', $this->plugin_url . 'assets/js/classie.js', array( 'jquery' ), $this->plugin_version);

      wp_enqueue_script( $this->plugin_slug . '-borderMenu', $this->plugin_url . 'assets/js/borderMenu.js', array( 'jquery' ), $this->plugin_version );
