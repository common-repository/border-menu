    ...
    <div id="post-body" class="metabox-holder columns-2">
      ...
      <div id="postbox-container-1" class="postbox-container">
        ...
        <div id="submitdiv" class="postbox ">
          <h2 class="hndle ui-sortable-handle"><span><?php _e('Publish', $this->text_domain); ?></span></h2>

          <div class="inside">
            <div class="container">
              <div class="element">
                <?php echo self::option($show); ?>
                <span id="shortcode"><code>[<?php echo $this->shortcode; ?> id="<?php echo $tool_id; ?>"]</code></span>
              </div>
            </div>
          ...
          <div class="inside">
            <div class="tab-box">
              <ul class="tab-nav">
                <?php
                $tab_menu = array(
                  'main'   => __('Style', $this->text_domain),
                  'menu_1' => __('Menu 1', $this->text_domain),
                  'menu_2' => __('Menu 2', $this->text_domain),
                );
                $i = 1;
