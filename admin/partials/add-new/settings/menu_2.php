...
if ( $count_ii > 0 ) {
  for ( $i = 0; $i < $count_ii; $i++ ) {
    ...
    $custom_icon_[ $i ] = array(
      'name'  => 'param[menu_2][custom_icon][]',
      'type'  => 'checkbox',
      'class' => 'custom-icon',
      'val'   => isset( $param[ 'menu_2' ][ 'custom_icon' ][ $i ] ) ? $param[ 'menu_2' ][ 'custom_icon' ][ $i ] : 0,
      'func'  => 'customicon(this);',
    );
    $custom_icon_url_[ $i ] = array(
      'name'   => 'param[menu_2][custom_icon_url][]',
      'type'   => 'text',
      'class'  => 'custom-icon-url',
      'val'    => isset( $param[ 'menu_2' ][ 'custom_icon_url' ][ $i ] ) ? $param[ 'menu_2' ][ 'custom_icon_url' ][ $i ] : '',
      'option' => array(
    ...
    $item_share_[ $i ] = array(
      'name'   => 'param[menu_2][item_share][]',
      'type'   => 'select',
      'val'    => isset( $param[ 'menu_2' ][ 'item_share' ][ $i ] ) ? $param[ 'menu_2' ][ 'item_share' ][ $i ] : '',
      'option' => array(
